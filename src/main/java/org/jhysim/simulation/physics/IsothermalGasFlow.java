...
/**
 * To simulate a gas not enclosed and free to expand in every directions
 * @author Sébastien Majerowicz
 */
public class IsothermalGasFlow extends NumericalSchema
{
 ...
 * Constructor
 */
	public IsothermalGasFlow ()
	{
		super();

		this.name = "Isothermal Gas Flow";
 ...
 */
	public IsothermalGasFlow (ArrayList<double[]> profiles, ArrayList<Double> variables)
	{
		super();
 ...
 */
	public IsothermalGasFlow (double[] density, double[] velocity, double soundspeed, double dt, double smoothingFactor)
	{
		super();
...
//first cell
		...
		this.density[0] = this.density[0] - (this.density[1]*this.velocity[1] -
...
//last cell
		...
		this.density[this.ncells-1] = this.density[this.ncells-1] - (this.density[this.ncells-1]*this.velocity[this.ncells-1] -
																	 oldleftdensity*oldleftvelocity)*dt*0.5/dx;;
